...
* The available government types are Revolution (a renamed Anarchy), Constitutional Monarchy, Democracy, Communism and Fascism — since the 20th Century was militarily characterised by conflict between those three systems.
  ...
  - Communism has less corruption (varying with distance), but has waste of shields, is bad at science, and produces extra pollution.  It gets two additional content citizens per city, and can build the KGB Headquarters smallwonder to copy techs developed elsewhere.
